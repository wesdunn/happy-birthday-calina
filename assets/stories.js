window.STORY1 =
  'Twas the night before Christmas, when all through the {{Noun (dwelling):house}}'+ '</br>' +
  'Not a creature was stirring, not even a {{Animal:mouse}}.'+ '</br>' +
  'The stockings were hung by the chimney with care,'+ '</br>' +
  'In hopes that St Nicholas soon would be there.'+ '</br>' +
  '</br>'+
  'The children were nestled all snug in their beds,'+ '</br>' +
  'While visions of sugar-plums {{Action Verb:danced}} in their heads.'+ '</br>' +
  'And mamma in her ‘kerchief, and I in my {{Article of Clothing:cap}},'+ '</br>' +
  ...
  'But a miniature {{Mode of Transportation:sleigh}}, and {{Number:eight}} tiny reindeer.'+ '</br>' +
  '</br>'+
  'With a little old driver, so lively and quick,'+ '</br>' +
  'I knew in a moment it must be St Nick.'+ '</br>' +
  'More rapid than {{Animal (plural):eagles}} his coursers they came,'+ '</br>' +
  'And he whistled, and shouted, and called them by name!'+ '</br>' +
  '</br>'+
  '"Now, Dasher! now, Dancer! now, Prancer and {{Name:Vixen}}!'+ '</br>' +
  'On, Comet! On, Cupid! on, {{Name:Donner}} and Blitzen!'+ '</br>' +
  ...
  'With the {{Mode of Transportation:sleigh}} full of {{Thing (plural):Toys}}, and St Nicholas too.'+ '</br>' +
  '</br>'+
  'And then, in a twinkling, I heard on the roof'+ '</br>' +
  'The {{Verb (-ing):prancing}} and pawing of each little hoof.'+ '</br>' +
  'As I drew in my head, and was turning around,'+ '</br>' +
  'Down the chimney St Nicholas came with a bound.'+ '</br>' +
  '</br>'+
  'He was dressed all in {{Clothing Material:fur}}, from his head to his foot,'+ '</br>' +
  'And his clothes were all tarnished with ashes and soot.'+ '</br>' +
  'A bundle of {{Thing (plural):Toys}} he had flung on his back,'+ '</br>' +
  'And he looked like a peddler, just opening his pack.'+ '</br>' +
  '</br>'+
  'His eyes-how they {{Adjective (-ed):twinkled}}! his dimples how merry!'+ '</br>' +
  'His cheeks were like roses, his {{Facial Feature:nose}} like a cherry!'+ '</br>' +
  'His droll little mouth was drawn up like a bow,'+ '</br>' +
  'And the beard of his chin was as {{Color:white}} as the snow.'+ '</br>' +
  '</br>'+
  'The stump of a pipe he held tight in his teeth,'+ '</br>' +
  'And the smoke it encircled his head like a {{Holiday Decoration:wreath}}.'+ '</br>' +
  'He had a broad face and a little round belly,'+ '</br>' +
  'That shook when he {{Adjective (-ed):laughed}}, like a bowlful of jelly!'+ '</br>' +
  '</br>'+
  'He was chubby and plump, a right {{Mood (-y):jolly}} old elf,'+ '</br>' +
  'And I {{Verb (-ed):laughed}} when I saw him, in spite of myself!'+ '</br>' +
  'A wink of his eye and a twist of his head,'+ '</br>' +
  'Soon gave me to know I had nothing to dread.'+ '</br>' +
  '</br>'+
  'He spoke not a word, but went straight to his work,'+ '</br>' +
  'And filled all the {{Article of Clothing:stockings}}, then turned with a jerk.'+ '</br>' +
  'And laying his {{Body Part:finger}} aside of his nose,'+ '</br>' +
  'And giving a nod, up the chimney he rose!'+ '</br>' +
  '</br>'+
  'He sprang to his {{Mode of Transportation:sleigh}}, to his team gave a whistle,'+ '</br>' +
  'And away they all flew like the down of a thistle.'+ '</br>' +
  'But I heard him exclaim, ‘ere he drove out of sight,'+ '</br>' +
  '"Merry Christmas to all, and to all a good-{{Time of Day:night}}!"';

window.STORY2 = 
  'Rudolph, the {{Color:red}}-nosed reindeer'+ '</br>' +
  'had a very {{Adjective (-y):shiny}} nose.'+ '</br>' +
  ...
  'won\'t you guide my {{Mode of Transportation:sleigh}} tonight?"'+ '</br>' +
  '</br>'+
